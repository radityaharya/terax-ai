...
fn build_git_command(
    ...
    // Core runs on the execution host itself (desktop local or remote agent):
    // git always spawns directly. The desktop's WSL arm lives in the Tauri
    // wrapper, not here.
...
mod tests {
    ...
    use super::super::types::TextSource;
    #[cfg(windows)]
    use crate::workspace::WorkspaceEnv;
    use std::collections::HashMap;
    #[cfg(windows)]
    ...
    #[test]
    fn builds_direct_git_command_with_cwd() {
